...
export default function Register() {
  ...
  return (
    <div className="register-page">
      ...
      <style>{`
        .register-page 
        { min-height: 100vh; position: relative; overflow-x: hidden; background-image: url("https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=2200&q=85"); background-size: cover; background-position: center; background-attachment: fixed; 
         }
        .register-overlay
         { position: absolute; inset: 0; background: linear-gradient(135deg, rgba(4,46,105,.86), rgba(13,92,184,.60), rgba(255,255,255,.15)); backdrop-filter: blur(1px); 
          }
